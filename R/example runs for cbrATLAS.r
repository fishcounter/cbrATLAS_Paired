...
AdjSurv.fn(taglife.file="../microtagtest for Atlas.csv",taghist.file="data/Paired_Release_ATLAS_Practice_File.csv",taglife.model="weibull",num.release=2,study.type="paired")

AdjSurv.fn(taglife.file="data/JDay2011_TagLifepooled.csv",taghist.file="data/chinR1_R3_JDay2011.csv",taglife.model=NULL,num.release=2,study.type="paired") 


########## problem w/common reaches--common values not displaying properly (ie, not common param, and se for 2nd is set to 0)


## github for cbrATLAS

https://github.com/fishcounter/cbrATLAS_Paired/blob/main/R/